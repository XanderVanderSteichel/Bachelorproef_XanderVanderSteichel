...
\begin{itemize}
    ...
    \begin{figure}[H]  % Use [H] to prevent floating
        \centering
        \includegraphics[width=0.5\textwidth]{foto's/Flowchart.png}  % Adjust width if necessary
    ...
    \begin{figure}[H]  % Use [H] to prevent floating
        ...
        \resizebox{\textwidth}{!}{%
            \begin{ganttchart}[
                ...
                progress=100,
                name=testen
                ]{Fase 3: Testen en Optimalisatie van de Geselecteerde Pipeline}{2025-04-05}{2025-04-25} \\
...
De Jenkins-pipeline bleek stabiel en robuust onder normale omstandigheden en bij gecontroleerde fouten. Door het verbod op gelijktijdige builds worden bestellingen veilig sequentieel verwerkt, wat een betrouwbare flow oplevert. Er zijn ook nog tal van mogelijkheden om de configuratie te verbeteren of uit te gaan breiden. Maar op deze manier aan de slag gaan, lijkt een goedkope en innovatieve oplossing.
